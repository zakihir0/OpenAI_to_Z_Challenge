...
class OpenAIIntegration:
    """Enhanced OpenRouter + Deepseek API integration for archaeological analysis"""
...
class ArchaeologicalSiteDetector:
    ...
    def __init__(self, openai_api_key: str, base_url: str = None, model: str = None):
        self.openai = OpenAIIntegration(openai_api_key, base_url, model)
...
def main():
    ...
    output_file = f'results/analysis_results_{timestamp}.json'
